	...
	class CoCart_Pro_Admin_Notices {
		...
		public function check_cocart_pro_dependency() {
			...
			if ( ! defined( 'COCART_GET_CART_ENHANCED' ) ) {
				add_action( 'admin_notices', array( $this, 'cocart_enhanced_not_installed' ) );
				return false;
			}
		...
		/**
		 * CoCart Enhanced is Not Installed or Activated Notice.
		 *
		 * @access public
		 * @return void
		 */

		public function cocart_enhanced_not_installed() {
			include_once( COCART_PRO_FILE_PATH . '/includes/admin/views/html-notice-cocart-enhanced-not-installed.php' );
			} // END cocart_enhanced_not_installed()				
